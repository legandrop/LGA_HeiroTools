...
```text
{
  ...
  agregar dropdown CPU junto a los botones inferiores,
  presets CPU: High 6/6, Medium 4/4, Low 2/2, Minimal 1/1,
  persistir CPU en ImportShots.ini,
  aplicar CPU desde el manager justo antes de lanzar cada proximo worker,
  escribir workers y exrmetrics_threads en el manifest,
